    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_user_active', models.CharField(blank=True, choices=[('ACTIVATE', 'Activate'), ('DEACTIVATE', 'Deactivate')], default='ACTIVATE', max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_image', models.FileField(blank=True, null=True, upload_to='post-images')),
